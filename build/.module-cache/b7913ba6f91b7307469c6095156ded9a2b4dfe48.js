...
var Student = React.createClass({displayName: 'Student',
  render: function(){
    ...
    $.each( (this.props.data.links || []), function(index, val) {
      if(index == "linkedin"){
        links.push(
          React.DOM.div( {className:"profile-link"}, 
        ...
        links.push(
          React.DOM.div( {className:"profile-link"}, 
            React.DOM.a( {href:mailto, className:"profile-link pull-right"} ,  " ", React.DOM.img( {className:"img-responsive", src:"img/email.png"} ), " " )
          )
        );
