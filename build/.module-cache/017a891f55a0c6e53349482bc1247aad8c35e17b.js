      ...
      React.DOM.div( {className:"student-container col-lg-4 col-md-6"}, 
        React.DOM.div( {className:"student-inner"}, 
          ...
          React.DOM.div( {className:"content-container row"}, 
            ...
            React.DOM.div( {className:"col-sm-12 text-center student-major"}, 
            ...
            React.DOM.div( {className:"col-sm-12 text-center student-year"}, 
              React.DOM.small(null, 
                "Class"
              ),
              React.DOM.h1(null, 
...
var Students = React.createClass({displayName: 'Students',
  render: function(){
    ...
    students.sort(function(student1, student2){
      return YearToValue(student1.year.tolower()) - YearToValue(student2.year.tolower());
    })
