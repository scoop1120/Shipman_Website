...
var Student = React.createClass({displayName: 'Student',
  render: function(){
    ...
    var links = [];
    $.each( (this.props.links || []), function(index, val) {
      if(index == "linkedin"){
        links.push(
          React.DOM.a( {href:val} ,  " ", React.DOM.img( {src:"img/linkedin.png"} ), " " )
        )
      }
      else if(index == "email"){
        var mailto = "mailto:" + val;
        links.push(
          React.DOM.a( {href:mailto} ,  " ", React.DOM.img( {src:"img/linkedin.png"} ), " " )
        )
